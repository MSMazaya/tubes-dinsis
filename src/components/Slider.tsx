...
function Slider({ name }: SliderProps) {
    ...
    return (
        <div class="p-2">
            ...
            <input id={name + "_slider_id"} type="range" onInput={(e: any) => setSliderValue(e.target.value)} value={sliderValue()} class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer dark:bg-gray-700" />
        </div>
    )
}
